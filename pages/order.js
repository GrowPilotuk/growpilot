  ...
  return (
    <div className="min-h-screen bg-green-50 p-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-xl">
        ...
        <form 
          action="https://formspree.io/f/mnqepnkd" 
          method="POST" 
          className="space-y-4"
        >
          <input type="hidden" name="Selected Plan" value={plan} />
          <input type="hidden" name="Selected Add-ons" value={Object.keys(addons).filter(name => addons[name]).join(', ')} />
