  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <section id="plans" className="py-20 px-8 bg-green-50 text-center">
        ...
        <p className="max-w-3xl mx-auto mb-16">Tailored grow room designs for every grower, from beginners to professionals. Choose your path to a better grow!</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="border p-8 rounded-3xl shadow-2xl hover:scale-105 transition bg-white">
            ...
            <Link href="/order?plan=GrowBasic">
              <button className="bg-green-600 text-white w-full mt-6 py-3 rounded-3xl hover:bg-green-700">Get GrowBasic</button>
            </Link>
          </div>
          ...
          <div className="border p-8 rounded-3xl shadow-2xl hover:scale-105 transition bg-green-100">
            ...
            <Link href="/order?plan=GrowPro">
              <button className="bg-green-600 text-white w-full mt-6 py-3 rounded-3xl hover:bg-green-700">Get GrowPro</button>
            </Link>
          </div>
          ...
          <div className="border p-8 rounded-3xl shadow-2xl hover:scale-105 transition bg-white">
            ...
            <Link href="/order?plan=GrowMaster">
              <button className="bg-green-600 text-white w-full mt-6 py-3 rounded-3xl hover:bg-green-700">Get GrowMaster</button>
            </Link>
          </div>
        </div>
      </section>
